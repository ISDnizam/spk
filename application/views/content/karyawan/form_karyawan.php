      ...
      <div class="col-xs-12 col-sm-12 col-md-8">
        ...
        <h5><?php echo $title;?></h5>
          ...
          <div class="form-group">
            ...
            <input type="text" class="form-control" id="kt" name="karyawan[nik]"  value="<?php if(!empty($edit)){ echo $edit->nik; }?>" required>
          </div>
        </div>
        <div class="col-md-6">
          <div class="form-group">
          ...
          <div class="form-group">
            ...
            <input type="number" class="form-control" id="kt" name="karyawan[tahun_masuk]"  value="<?php if(!empty($edit)){ echo $edit->tahun_masuk; }?>" required>
          </div>
        </div>
        <div class="col-md-6">
          <div class="form-group">
            <label for="kt">Masa Kerja</label>
            <input type="text" class="form-control" id="kt" name="karyawan[masa_kerja]"  value="<?php if(!empty($edit)){ echo $edit->masa_kerja; }?>" required>
          </div>
        </div>
        <div class="col-md-6">
          <div class="form-group">
