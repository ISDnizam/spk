 ...
 <?php  // =================================HITUNG KRITERIA ======================================= // ?>
    <br>
    <b>Penilaian Kinerja Karyawan Non Medis</b></br>
    <table class='table table-striped table-bordered table-hover'>
      ...
      <tbody>
        ...
        foreach ($list_aspek_kinerja_non_medis as $key) { $no++;
    ...
    <table class='table table-striped table-bordered table-hover'>
      ...
      <tbody>
        <?php $no=0; 
        foreach ($aspek_kinerja_non_medis as $key) { $no++;
        $total_kriteria = count($aspek_kinerja_non_medis);
         ?>
        <tr>
 ...
 <hr>
    <b>Nilai Bobot Akhir Kinerja Karyawan Non Medis</b></br>
    <table class='table table-striped table-bordered table-hover'>
      <thead>
        <tr>
          <th>Kode Kriteria</th>
 ...
 <?php  // =================================HITUNG KRITERIA ======================================= // ?>
    <br>
    <b>Penilaian Kinerja Karyawan Medis</b></br>
    <table class='table table-striped table-bordered table-hover'>
      <thead>
        <tr>
          <th>K</th>
      ...
      <tbody>
        <?php $no=0; 
        $tt=0;
        foreach ($list_aspek_kinerja_medis as $key) { $no++;
        $total_kriteria = get_count_sub_kriteria($key->id_kriteria);
    ...
    <table class='table table-striped table-bordered table-hover'>
      ...
      <tbody>
        <?php $no=0; 
        foreach ($aspek_kinerja_medis as $key) { $no++;
        $total_kriteria = count($aspek_kinerja_medis);
         ?>
        <tr>
          <td><b><?php echo $key->kode_kriteria;?></b></td>
          <td><?php echo $key->prioritas;?></td>
        ...
        <hr>
    <b>Nilai Bobot Akhir Aspek  Kinerja Karyawan Medis</b></br>
    <table class='table table-striped table-bordered table-hover'>
      <thead>
        <tr>
          <th>Kode Kriteria</th>
